...
def logging_with_mlflow_metric(results):
    ...
    best_metrics_dict = {
        ...
        "best_bi_val": results["val"][best_binary_epoch][2],
        "best_ma_val": results["val"][best_macro_epoch][3],
        "best_mi_val": results["val"][best_micro_epoch][1],
        "best_auc_test": results["test"][best_auc_epoch][0],
        "best_bi_test": results["test"][best_binary_epoch][2],
        "best_ma_test": results["test"][best_macro_epoch][3],
        "best_mi_test": results["test"][best_micro_epoch][1]
    }
